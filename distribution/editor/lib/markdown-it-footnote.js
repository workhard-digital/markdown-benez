/*! For license information please see markdown-it-footnote.js.LICENSE.txt */
(function(f) {
    ...
    1: [ function(require, module, exports) {
      ...
      module.exports = function sub_plugin(md) {
        ...
        function footnote_def(state, startLine, endLine, silent) {
          var oldBMark, oldTShift, oldParentType, pos, label, token, start = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine];
          if (start + 4 > max) {
            return false;
          }
        ...
        function footnote_inline(state, silent) {
          var labelStart, labelEnd, footnoteId, oldLength, token, max = state.posMax, start = state.pos;
          if (start + 2 >= max) {
            return false;
          }

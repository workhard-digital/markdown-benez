(function() {
  ...
  function scriptHint(editor, keywords, getToken) {
    ...
    while (tprop.className == "property") {
      ...
      if (tprop.string == ")") {
        ...
        if (tprop.className == "variable") tprop.className = "function"; else return;
      }
  ...
  function getCompletions(token, context, keywords) {
    ...
    if (context) {
      ...
      if (obj.className == "variable") base = window[obj.string]; else if (obj.className == "string") base = ""; else if (obj.className == "atom") base = 1; else if (obj.className == "function") {
        if (window.jQuery != null && (obj.string == "$" || obj.string == "jQuery") && typeof window.jQuery == "function") base = window.jQuery(); else if (window._ != null && obj.string == "_" && typeof window._ == "function") base = window._();
      }
